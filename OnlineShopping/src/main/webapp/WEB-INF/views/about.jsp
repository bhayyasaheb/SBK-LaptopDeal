 ...
 -->
	...
	<div class="container">
		<div class="jumbotron jumbotron-sm"
			style="background-color: purple; margin-top: 2%; color: white;">
			<div class="row">
				<div class="col-sm-12 col-lg-12">
					<h1 class="h2" style="margin-top: -2%">NIIT</h1>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="well">
					...
					<p style="margin-top: 6%; line-height: 35%">Ghatkopar East, Mumbai, Maharashtra 400077</p>
					<br /> <br />
					<h3 style="line-height: 20%;">
						<i class="fa fa-envelope fa-1x"
							style="line-height: 6%; color: #339966"></i> Website:
					</h3>
					<p style="margin-top: 6%; line-height: 35%"> http://www.niit.com</p>
					<br /> <br />
					<h3 style="line-height: 20%;">
